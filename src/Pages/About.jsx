        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
              Mobile Engineer skilled in Flutter, React Native, and Swift with focus on clean, scalable architecture. Delivered production apps like Nafeza and Employee Attendance. Proficient in BLoC, Cubit, GetX, Firebase, Maps, and PayMob integration. Strong in cross-platform delivery, performance tuning, and agile collaboration.
            </p>
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Leveraging AI as a professional tool, not a replacement."
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1aAnHhH1BMYHFgZ9J8jUCT2G9ccZOEgeT/view?usp=sharing" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
